...
<head>
    ...
    <title>التقويم الشهري - Monthly Calendar</title>
                            ...
                            <div className="space-y-1">
                                {dayEvents.map((event, index) => (
                                    ...
                                    >
                                        ...
                                        <button
                                            onClick={(e) => deleteEvent(day, index, e)}
                                            className="opacity-0 group-hover:opacity-100 transition-opacity text-purple-600 hover:text-purple-900 text-base"
                                        >
                                            ✕
                                        </button>
                                    </div>
